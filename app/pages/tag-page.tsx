...
const tags = [
  ...
  { id: '2', name: 'Comedy', count: 120 },
  { id: '3', name: 'Drama', count: 200 },
  { id: '4', name: 'Sci-Fi', count: 80 },
  { id: '5', name: 'Romance', count: 100 },
  { id: '6', name: 'Thriller', count: 90 },
  { id: '7', name: 'Horror', count: 70 },
  { id: '8', name: 'Adventure', count: 110 },
  { id: '9', name: 'Animation', count: 60 },
  { id: '10', name: 'Documentary', count: 50 },
]
      ...
      <main className="flex-grow container mx-auto p-4">
        ...
        <div className="flex flex-wrap gap-4">
          {filteredTags.map((tag) => (
            <Badge key={tag.id} variant="secondary" className="text-lg py-2 px-4">
              {tag.name} ({tag.count})
            </Badge>
          ))}
        </div>
